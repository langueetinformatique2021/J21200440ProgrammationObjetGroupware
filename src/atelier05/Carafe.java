...
public class Carafe {
	...
	/**
	 * deux carafes this et c transvaser le contenu de this dans c
	 * 
	 * @param c carafe
	 */
	public void Transvaser(Carafe c) {
		...
		if (this.Contenu() > resteC) {
			// this.Contenu() > resteC on ne peut vider pas complétement this mais on
			// remplit complétement c2
			c.Remplir();
			this.Contenu(this.Contenu() - resteC);
		} else {
			// this.Contenu() < resteC on vide complétement this mais on ne remplit pas
			// complétement c2
